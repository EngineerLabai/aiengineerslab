          ...
          <div className="grid gap-1">
            {section.links.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="flex items-center justify-between rounded-xl px-3 py-2 text-xs font-semibold text-slate-800 transition hover:bg-slate-100 hover:translate-x-1"
              >
      ...
      <div className="space-y-1">
        {section.links.map((link) => (
          <Link
            key={link.href}
            href={link.href}
            className="block rounded-full px-3 py-2 text-[11px] font-semibold text-slate-700 transition hover:bg-slate-100 hover:translate-x-1"
          >
            {link.label}
          </Link>
        ))}
